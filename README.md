...
> **Oxirgi tekshiruv vaqti:** `2026-09-06 16:16:31 (UTC+5)`

| Servis | URL | Holati | HTTP Status | Javob tezligi |
| :--- | :--- | :---: | :---: | :---: |
| **Safaar Production API** | `https://api.safaar.uz/v1/health` | 🟢 Operational | `200` | `1407ms` |
| **GitHub Public API** | `https://api.github.com` | 🟡 Degraded | `403` | `61ms` |
| **Cloudflare DNS** | `https://1.1.1.1` | 🟢 Operational | `200` | `57ms` |
