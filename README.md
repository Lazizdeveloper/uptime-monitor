...
> **Oxirgi tekshiruv vaqti:** `2026-09-26 00:07:39 (UTC+5)`

| Servis | URL | Holati | HTTP Status | Javob tezligi |
| :--- | :--- | :---: | :---: | :---: |
| **Safaar Production API** | `https://api.safaar.uz/v1/health` | 🟢 Operational | `200` | `1655ms` |
| **GitHub Public API** | `https://api.github.com` | 🟢 Operational | `200` | `50ms` |
