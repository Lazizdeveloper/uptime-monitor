...
> **Oxirgi tekshiruv vaqti:** `2026-09-14 14:17:45 (UTC+5)`

| Servis | URL | Holati | HTTP Status | Javob tezligi |
| :--- | :--- | :---: | :---: | :---: |
| **Safaar Production API** | `https://api.safaar.uz/v1/health` | 🟢 Operational | `200` | `2106ms` |
| **GitHub Public API** | `https://api.github.com` | 🟢 Operational | `200` | `93ms` |
| **Cloudflare DNS** | `https://1.1.1.1` | 🟢 Operational | `200` | `114ms` |
