...
> **Oxirgi tekshiruv vaqti:** `2026-09-16 23:38:48 (UTC+5)`

| Servis | URL | Holati | HTTP Status | Javob tezligi |
| :--- | :--- | :---: | :---: | :---: |
| **Safaar Production API** | `https://api.safaar.uz/v1/health` | 🟢 Operational | `200` | `1853ms` |
| **GitHub Public API** | `https://api.github.com` | 🟡 Degraded | `403` | `106ms` |
